...
def myParseArgs():
    ...
    parser.add_argument('--config', default='SZU-cover-resample-256-C1stc-hill-0.4', help="train result")

    parser.add_argument('--datacover', help='path to dataset',default='/data/ymx/SZU-cover-resample-256/')
    parser.add_argument('--costroot', help='path to cost',default='/data/ymx/HILL_szu2/0.4/')
    parser.add_argument('--indexpath', help='path to index',default='./index_list/szu_gan_train_4w.npy')

    parser.add_argument('--root', default='/data/ymx/', help="path to save result")
...
def main():
    ...
    changeRate = changeRate / (40000.0 * args.imageSize * args.imageSize)
