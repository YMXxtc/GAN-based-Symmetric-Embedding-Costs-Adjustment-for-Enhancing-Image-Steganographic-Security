...
def main(args):
  ...
  BOSSBASE_COVER_DIR = '/data2/hdx/BossBase-1.01-cover-resample-256'
  BOSSBASE_STEGO_DIR = '/data2/hdx/HILL/BossBase-hill-stego-1'
  
  BOWS_COVER_DIR = '/data/ymx/BossBose_data_jpeg_block/BOWS2-cover-resample-256-jpeg-75-non-rounded-{:.2f}'.format(PROP)
  BOWS_STEGO_DIR = '/data/ymx/BossBose_data_jpeg_block/BOWS2-{}-{}-resample-256-jpeg-75-non-rounded-{:.2f}'.format(STEGANOGRAPHY, EMBEDDING_RATE,PROP)
