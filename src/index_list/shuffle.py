...
'''
test_list = list(range(1,40001))
random.shuffle(test_list)
test_list = np.array(test_list)
print(test_list)
print(len(test_list))
np.save('szu_gan_train_4w.npy', test_list)
'''
...
train_list = list[:5000]
train_list = np.array(train_list)
np.save('bb_train_index.npy', train_list)
#print(len(train_list))

valid_list = list[5000:6000]
valid_list = np.array(valid_list)
np.save('bb_valid_index.npy', valid_list)
#print(len(valid_list))

test_list = list[6000:]
test_list = np.array(test_list)
np.save('bb_test_index.npy', test_list)
#print(len(test_list))
